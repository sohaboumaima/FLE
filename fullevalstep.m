function [x, f, g, H, beta, success, func_eval] = fullevalstep(fun, x, f, H, x_old, g_old, h, Z, numfe, pr, alpha, unconst)
...
% Author: Oumaima Sohab
    ...
    [beta, fval, f, d, x] = armijo_proj(f, fun, x, H, g, alpha, pr, Z, unconst);
    func_eval = fe + fval;
